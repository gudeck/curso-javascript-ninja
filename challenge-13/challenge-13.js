(function () {
  ...
  */
  ...
  brasil.unshift('Amazonas', 'Acre', 'Tocantins');
  console.log(brasil);
  ...
  */
  var newBrasil = brasil.map(function (value, index) {
    return {id: index, estado: value};
  });
  ...
  */
  ...
  var condicao = brasil.every(function (value) {
  ...
  */
  ...
  condicao = brasil.some(function (value) {
    return value === 'Ceará';
  });
